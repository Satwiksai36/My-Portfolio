...
export default function NotFound() {
  ...
  return (
    <main className="relative w-full min-h-screen bg-white overflow-hidden flex flex-col">
      ...
      >
        {/* Logo */}
        <Link href="/" aria-label={portfolioData.brandName || 'Portfolio'}>
          <Image
            src={portfolioData.logoBlack || '/logo/weblogo-black.png'}
      ...
      >
        <span
          ...
          style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
        >
          © 2026 {portfolioData.fullName} · {portfolioData.brandName || 'Portfolio'}
        </span>
        <span
      ...
      >
        ...
        >
          {portfolioData.brandName || 'Portfolio'} · 2026
        </span>
        <div className="w-px h-12 bg-black/8" />
      </motion.div>
